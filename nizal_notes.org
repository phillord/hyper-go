 ...
 * Terms not found in ChEBI:
   + Basic amino acid	(DV) mapped to ch/amino_acid and add a property hasAcidity alkaline
   + Neutral amino acid	(DV) mapped to ch/amino_acid and add a property hasAcidity Neutral
   + Acidic amino acid	(DV) mapped to ch/amino_acid and add a property hasAcidity Acidic
   + Sugar               NOT DEFINED YET : look like sugar in GO immaterial concept !
   + lactoferrin    GO:0033569 : define new class as a subclass of ch/protein
   + Transferrin    GO:0033570 : define new class as a subclass of ch/iron_3+_
   + Copper chelate GO:0051981 : define new class as a subclass of ch/copper_cation
   + copper-nicotianamine GO:0051982 : define new class as a subclass of the CopperChelate.
   ...
   + adhesin autotransporter activity GO:0015475 : efine new class as a subclass of ch/chemical_entity
