...
GO:0042895 Antibiotic transmembrane transporter = antimicrobial agen CHEBI:33281 \\
antimicrobial agen is NOT a subclass of drug CHEBI:23888
...
** Diff classification between GO and ChEBI
  + In many cases a term in GO has no role or some roles, whereas in ChEBI has some extra roles. For example GO:1905131 and GO:0034634
...
(DV) define the term as S-methylmethionine
  ...
  + GO:0030233 deoxynucleotide different from the process GO:0030302. In Chebi I think it is classified as deoxyribonucleotide
 ...
 * GO classification
  ...
  ** active transport, which often moves material from area of low concentration to area of higher concentration, and therefore referred to as moving the material "against the concentration gradient"
...
** Active transport
 ...
 + active borate transmembrane transporter activity GO:0046715 is an active but does not the driven by molecule. 
According to this: Park, M., Li, Q., Shcheynikov, N., Zeng, W. and Muallem, S., 2004. NaBC1 is a ubiquitous electrogenic Na+-coupled borate transporter essential for cellular boron homeostasis and cell growth and proliferation. Molecular cell, 16(3), pp.331-341. It is sodium ion Na+
 ...
 * There are some terms in GO classified as is_a drug, whereas in ChEbi they are not. For example: GO:0042878
